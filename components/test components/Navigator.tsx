  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="MainTestPage">
        ...
        <Stack.Screen name="DeviceStatusTestPage" component={DeviceStatusTestPage} />
        <Stack.Screen name="DeviceStatusTestPageBluetooth" component={DeviceStatusTestPageBluetooth} />
        <Stack.Screen name="Test Reboot" component={RebootTestPage} />
        <Stack.Screen name="Test Set Battery Alert" component={LowBatteryTestPage} />
        ...
        <Stack.Screen name="Test general failure" component={GeneralFailureTestPage} />
        <Stack.Screen name="Test battery status" component={BatteryTestPage} />
        <Stack.Screen name="Test device status autoupdate" component={DeviceStatusAutoTestPage} />
      </Stack.Navigator>
    </NavigationContainer>
  );
};